...
class GameSequential:
    def __init__(self, width=1920, height=1080, cell_size=20):
        ...
        self.grid = GridSequential(self.rows, self.cols)
        ...
        self.input_size = TextInput(520, height - 40, 80, 30, str(self.cell_size))
